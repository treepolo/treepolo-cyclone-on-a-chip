...
export class GpuRotatingDryCore{
  ...
  private prepareBase(dt:number):void{const ab=new ArrayBuffer(48),u=new Uint32Array(ab),f=new Float32Array(ab);u[0]=this.v.nz;u[1]=this.h.edgeCount;u[2]=this.h.cellCount;f[4]=dt;f[5]=EARTH.radius;f[6]=EARTH.gravity;f[7]=DRY_AIR.rd;f[8]=DRY_AIR.gamma;f[9]=DRY_AIR.pRef;this.device.queue.writeBuffer((this.core as any).paramsBuffer,0,ab)}
